		...
		//get drawing view
				...
				newBtn.setOnClickListener(new OnClickListener(){
					...
					public void onClick(View v) {
						...
						//new button
	AlertDialog.Builder newDialog = new AlertDialog.Builder(Signature.this);
	...
	newDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener(){
		   ...
		   newDialog.setNegativeButton("Cancel", new DialogInterface.OnClickListener(){
				...
				/*drawBtn.setOnClickListener(new OnClickListener(){
					...
					public void onClick(View v) {
						// TODO Auto-generated method stub
						final Dialog brushDialog = new Dialog(Signature.this);
		...
		saveBtn.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				AlertDialog.Builder saveDialog = new AlertDialog.Builder(Signature.this);
...
if(drawView.getId()==R.id.save_btn){
			//save drawing
