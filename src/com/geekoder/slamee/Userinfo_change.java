...
public class Userinfo_change extends Activity implements OnItemSelectedListener {
 ...
 private String[] Questions =  {"What is your name?" ,"What is your pet name?","Who is your inspiration?","Write your own question"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		user = name.getString("Username","0");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(username.getText().length()>0 && answer_edit.getText().length() > 0){
			    	...
			    	Intent i = new Intent(Userinfo_change.this,Home_page.class);
	                startActivity(i);
	                finish();
